...
// Task 2
let wordHell = [72, 101, 108, 108]
let wordFromCodePoints = String.fromCharCode(wordHell[0]) + String.fromCharCode(wordHell[1]) + String.fromCharCode(wordHell[2]) + String.fromCharCode(wordHell[3]);
